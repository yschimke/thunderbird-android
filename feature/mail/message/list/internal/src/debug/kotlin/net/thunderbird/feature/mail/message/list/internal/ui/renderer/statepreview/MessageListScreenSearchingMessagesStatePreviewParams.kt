...
@Composable
private fun ThunderbirdInboxSearchingCatalogPreview() {
    MessageListScreenSearchingMessagesStatePreview(
        params = MessageListScreenSearchingMessagesStatePreviewParamsProvider().params.first(),
    )
}
