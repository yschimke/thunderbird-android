...
private class MessageListScreenLoadedMessagesLayoutPreviewParamsProvider : MessageListScreenPreviewParamsProvider() {
    override val params = listOf(
        MessageListScreenPreviewParams(
            previewName = "Sender Above Subject",
        ...
        MessageListScreenPreviewParams(
            previewName = "No Avatar, No Favourite",
...
private fun MessageListScreenLayoutPreview(
    @PreviewParameter(MessageListScreenLoadedMessagesLayoutPreviewParamsProvider::class)
