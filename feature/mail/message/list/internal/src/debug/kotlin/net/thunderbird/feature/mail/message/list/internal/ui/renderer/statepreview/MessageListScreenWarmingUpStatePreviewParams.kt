...
@Composable
private fun ThunderbirdInboxWarmingUpCatalogPreview() {
    MessageListScreenWarmingUpStatePreview(
        params = MessageListScreenWarmingUpStatePreviewParamsProvider().params.first(),
    )
}
