...
@Composable
private fun ThunderbirdInboxLoadingCatalogPreview() {
    MessageListScreenLoadingMessagesStatePreview(
        params = MessageListScreenLoadingMessagesStatePreviewParamsProvider().params.first(),
    )
}
