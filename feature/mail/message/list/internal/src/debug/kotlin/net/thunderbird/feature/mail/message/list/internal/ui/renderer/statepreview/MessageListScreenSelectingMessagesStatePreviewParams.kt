...
private class MessageListScreenSelectingMessagesStatePreviewParamsProvider : MessageListScreenPreviewParamsProvider() {
...
private fun MessageListScreenSelectingMessagesStatePreview(
    @PreviewParameter(MessageListScreenSelectingMessagesStatePreviewParamsProvider::class)
...
@Composable
private fun ThunderbirdInboxSelectingCatalogPreview() {
    MessageListScreenSelectingMessagesStatePreview(
        params = MessageListScreenSelectingMessagesStatePreviewParamsProvider().params.first(),
    )
}
