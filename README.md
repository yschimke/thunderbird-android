# Thunderbird for Android — design artifacts

Importable sticker-sheet for **`Thunderbird Bolt`**, rendered from the committed
...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/thunderbird/)**

The same rendered components, served live by `compose-preview serve --catalogs thunderbird` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/thunderbird/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
