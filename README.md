# Thunderbird Bolt — design artifacts

Importable sticker-sheet for **`Bolt`**, rendered from the committed
`@Preview` catalog in [`yschimke/thunderbird-android`](https://github.com/yschimke/thunderbird-android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird-bolt/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird-bolt/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/thunderbird-bolt/)**

The same rendered components, served live by `compose-preview serve --catalogs thunderbird-bolt` —
...
| Cards and surfaces | 1 |

## What's in this branch

| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird-bolt/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/thunderbird-android/blob/design-artifacts/thunderbird-bolt/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/thunderbird-bolt/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/thunderbird-android/actions/workflows/design-artifacts.yml)
